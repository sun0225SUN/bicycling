...
# init_info = {
# 	'client_id': ${{ secrets.CLIENT_ID_TOKEN }},
# 	'client_secret': ${{ secrets.CLIENT_SECRET_TOKEN }}
# 	'code': ${{ secrets.CODE_TOKEN }},
# 	"grant_type": "authorization_code"
# }
...
class StravaApiHelper:
	...
	def GetGPXFile(self, supress=True):
		...
		id_list = pd.read_csv(self.data_folder + 'activity_summary_raw.csv',usecols=['id', 'start_date_local', 'type', 'manual', 'start_latlng'])
